  ...
  onSave() {
    if (this.usuarioForm.valid) {
      if (this.data.opcion === 'crear') {
        ...
        this.userService.storeUser(datos).subscribe((resp) => {
          this.onClose();
        ...
        this.userService.updateUser(datos).subscribe((resp) => {
          this.onClose();
